...
# check if script is executed rightfully, as .csv-file may be overwritten
...
print('Successfully scraped everything to table ' + tablename + '. Good job.')
